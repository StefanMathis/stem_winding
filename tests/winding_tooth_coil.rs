...
use slot::{SlotTrapezoidOpen, SlotTrapezoidSemi};
use std::sync::Arc;
...
fn test_winding_12_8_dl() {
    ...
    assert_eq!(4, winding.coil_groups_per_phase());
    ...
    approxim::assert_abs_diff_eq!(0.866, winding.winding_factor(1, 1.0), epsilon = 0.0001);
    approxim::assert_abs_diff_eq!(0.866, winding.winding_factor(1, -2.0), epsilon = 0.0001);
    approxim::assert_abs_diff_eq!(0.866, winding.winding_factor(1, 4.0), epsilon = 0.0001);
    approxim::assert_abs_diff_eq!(0.866, winding.winding_factor(1, -5.0), epsilon = 0.0001);
    approxim::assert_abs_diff_eq!(0.866, winding.winding_factor(1, 7.0), epsilon = 0.0001);
}
...
fn test_winding_12_10_dl() {
    ...
    // Check the winding factor
    approxim::assert_abs_diff_eq!(0.933, winding.winding_factor(1, 1.0), epsilon = 0.0001);
    approxim::assert_abs_diff_eq!(0.067, winding.winding_factor(1, -0.2), epsilon = 0.0001);
    approxim::assert_abs_diff_eq!(0.067, winding.winding_factor(1, 2.2), epsilon = 0.0001);
    approxim::assert_abs_diff_eq!(0.933, winding.winding_factor(1, -1.4), epsilon = 0.0001);
    approxim::assert_abs_diff_eq!(0.933, winding.winding_factor(1, 3.4), epsilon = 0.0001);
}
...
fn test_winding_12_10_sl() {
    ...
    // Check the winding factor
    approxim::assert_abs_diff_eq!(0.9659, winding.winding_factor(1, 1.0), epsilon = 0.0001);
    approxim::assert_abs_diff_eq!(0.2588, winding.winding_factor(1, -0.2), epsilon = 0.0001);
    approxim::assert_abs_diff_eq!(0.2588, winding.winding_factor(1, 2.2), epsilon = 0.0001);
    approxim::assert_abs_diff_eq!(0.9659, winding.winding_factor(1, -1.4), epsilon = 0.0001);
    approxim::assert_abs_diff_eq!(0.9659, winding.winding_factor(1, 3.4), epsilon = 0.0001);
}
...
fn test_default_tooth_coil_assembly() {
    ...
    let expected_result = WindingTable(DMatrix::from_column_slice(2, 3, &[-3, 1, -1, 2, -2, 3]));
...
fn test_deserialize_full() {
    ...
    assert_eq!(winding.parallel_paths(), 2);
}
